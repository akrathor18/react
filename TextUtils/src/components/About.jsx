...
function About() {
  ...
  <div className="mx-auto max-w-7xl px-4">
    <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
      ...
      <p className="max-w-4xl text-base dark:text-gray-300 text-gray-600 md:text-xl">
    ...
    <div className="my-8 flex flex-col gap-y-6 md:flex-row lg:justify-around">
      <div className="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
        ...
        <p className="w-full text-xl font-semibold dark:text-gray-200 text-gray-900">
          Bengaluru office
        </p>
        <p className="w-full text-base dark:text-gray-200 text-gray-700">Mon-Sat 9am to 5pm.</p>
      ...
      <div className="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
        ...
        <p className="w-full text-xl font-semibold dark:text-gray-200 text-gray-900">Head office</p>
        <p className="w-full text-base dark:text-gray-200 text-gray-700">Mon-Sat 9am to 5pm.</p>
        <p className="text-sm font-medium">
    ...
    <div className="mt-16 flex items-center">
      <div className="space-y-6 md:w-3/4">
        ...
        <p className="text-3xl font-bold dark:text-gray-200 text-gray-900 md:text-4xl">
          Meet our team
        </p>
        <p className="max-w-4xl text-base dark:text-gray-200 text-gray-700 md:text-xl">
    ...
    <div className="grid grid-cols-1 gap-4 gap-y-6 border-b border-gray-300 py-12 pb-20 md:grid-cols-2 lg:grid-cols-4">
      <div className="rounded-md border">
        ...
        />
        <p className="mt-6 w-full px-2 text-xl  font-semibold dark:text-gray-200 text-gray-900">
          Gabrielle Fernandez
        </p>
        <p className="w-full px-2 pb-6 text-sm font-semibold dark:text-gray-200 text-gray-500">
          Marketing Lead
        </p>
      </div>
      <div className="rounded-md border">
      ...
      <div className="rounded-md border">
        ...
        <p className="w-full px-2 pb-6 text-sm font-semibold dark:text-gray-500 text-gray-500">
          Marketing Lead
        </p>
      </div>
      <div className="rounded-md border">
