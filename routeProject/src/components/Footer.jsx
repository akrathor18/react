...
export function Footer() {
  const sections = [
    {
      title: 'Company',
      items: ['About us', 'Company History', 'Our Team', 'Our Vision', 'Press Release']
    },
    {
      title: 'Support',
      items: ['FAQ', 'Customer Service', 'Contact Us', 'Live Chat', 'Feedback']
    },
    {
      title: 'Legal',
      items: ['Privacy Policy', 'Terms of Service', 'Cookies Policy', 'Security', 'Compliance']
    }
  ];

  return (
    <footer className="w-full p-5 dark:bg-gray-900 dark:text-white">
